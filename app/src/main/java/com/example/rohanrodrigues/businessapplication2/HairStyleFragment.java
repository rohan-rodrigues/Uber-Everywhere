...
public class HairStyleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootview =  inflater.inflate(R.layout.hair_style, container, false);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println(Arrays.toString(currentCoords));
                System.out.println(Arrays.toString(desiredCoords));
